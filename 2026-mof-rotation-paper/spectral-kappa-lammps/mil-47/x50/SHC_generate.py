...
if __name__ == "__main__":
    ...
    n_cores = 1               # The number of cores for parallel computation of force constants, depends on one's machine

    ################################# For velocity files ###########################
    atomic_velocities_file = '../Velocity_Calculate/vels.dat'
    compact_velocities_file = 'vels.compact.dat'

    ##################### For smooth ##################
    frequency_window_width = 1.0e12   ## Hz
    ...
    # simulation details
    dn = 10
    simulation_step = 6000000
    NChunks = 10
    md_timestep = 1.0e-15   ## second
    area = 55.3451 * 54.7378    ## A^2, it depends on your case
    Tem_jump = 200         ## 60K is the temperature jump
